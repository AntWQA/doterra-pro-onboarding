...
const CARDS = [
  { src: minQual, left: -25.64, top: 161.19, width: 228.35, z: 1, floatDelay: 0 },
  { src: fastStart, left: 112.04, top: 126, width: 202.98, z: 2, floatDelay: 0.3 },
  { src: boostModule, left: 248.29, top: 224.01, width: 175, z: 3, floatDelay: 0.6 },
];
      ...
      {CARDS.map((card, i) => (
        ...
        >
          <motion.img
            ...
            style={{ width: "100%", display: "block", boxShadow: CARD_SHADOW }}
          />
        </motion.div>
      ))}
    </div>
